...
def createCommonNamesHTML():
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          The earliest mention of this name appears in John Lawson's <em>A New Voyage\n")
    outfile.write("          to Carolina</em>, published in 1709 (and republished as <em>The History of\n")
    outfile.write("          Carolina</em> in 1714) (p. 121):\n")
    ...
    outfile.write("          (<em class=\"species\">Uca pugilator</em>), Thomas Say (1817) reports (p. 72):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          Gould (1841) has a similar explanation when discussing the crab <em class=\"species\">Gelasimus vocans</em>\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          De Kay (1844) uses the term with respect to the same species in New York, but with a slightly different explanation (p. 14):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          In the book <em>Crab, Shrimp, and Lobster Lore</em> (1867), William Lord reports\n")
    outfile.write("          a different spin on the fishermen's perceiption of the fiddler crab (p. 29-30):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          Mark Twain also references them in Chapter 48 of <em>Life on the Mississippi</em>\n")
    outfile.write("          (1883):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          In his 1886 book <em>The Standard Natural History</em>, John S. Kingsley states (p. 64):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          </blockquote>\n")
    outfile.write("          Angelo Heilprin makes an even more confusing explanation in his 1888 book <em>The Animal Life of Our Sea-Shore</em> (p. 82).\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          By 1888, Kingsley changes his explanation to a more sensible one in in a paper in <em>The American Naturalist</em>\n")
    outfile.write("          (p. 889-890):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          Plumier (1905) gives a similar explanation (p. 148):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          from one of the earliest scientific papers to include these crabs, Rumphius\n")
    outfile.write("          (1705). Rumphius names one of his species <em class=\"species\">Cancer vocans</em>\n")
    ...
    outfile.write("          Uca vocans</em>) was adopted by Linnaeus\n")
    outfile.write("          (1758) and became the general name under which this group was known in\n")
    outfile.write("          Continental Europe. By 1778, writing in French, DeGeer uses the French\n")
    ...
    outfile.write("          Similarly, writing in German, Herbst (1782) builds off the German word\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          The term does find its way into English, such as Gosse (1851) discussing Jamaica (p. 50-51):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          </blockquote>\n")
    outfile.write("          or Plumier (1905) in New York (p. 148):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          Boyce (1924) prefers &ldquo;Calling Crab&ldquo; to &ldquo;Fiddler Crab&rdquo;, at least in part\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          Boone (1927) also explains both names:\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        <dd>\n")
    outfile.write("          In 1835, de Haan (writing in Latin) reports that the crab he calls\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          This term is first mentioned in English by Boone (1927) (p. 273):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          definitely by the revised edition of 1948). For example, in the fifth edition (1985), on p. 356:\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("        <dd>\n")
    outfile.write("          Translates to &ldquo;master tailor&rdquo; in English. Rathbun (1911, 1918) reports this as a local name for <em class=\species\">Uca princeps</em> in Peru.\n")
    ...
    outfile.write("        </dd>\n")
    outfile.write("        <dd>\n")
    outfile.write("          Boone (1927) also reports on this term (p. 273):\n")
    outfile.write("          <blockquote>\n")
    ...
    outfile.write("          the ear. Rathbun (1918) reported hearing this story from P.W. Jarvis of\n")
    outfile.write("          Kingston, specifically in reference to <em class=\"species\">Uca rapax.</em>\n")
    outfile.write("          Barnwell (1986) reported that the name was generally applied to all fiddler\n")
    ...
    outfile.write("        <dd>\n")
    outfile.write("          Henderson (1883) reports this as the local name on the eastern coast of India, near Madras (p. 329):\n")
    outfile.write("          <blockquote>\n")
...
def main():
    references,refDict,citeList = getReferences()
