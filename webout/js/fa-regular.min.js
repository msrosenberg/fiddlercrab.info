...
!function() {
    ...
    s[z].shims || (s[z].shims = []);
    var V = s[z], C = Object.assign || function(c) {
    ...
    !function(c) {
        ...
        !function c(h, v) {
            ...
            "function" == typeof V.hooks.addPack ? V.hooks.addPack(h, l) : V.styles[h] = C({}, V.styles[h] || {}, l), 
            "fas" === h && c("fa", v);
        }("far", a);
    });
}();