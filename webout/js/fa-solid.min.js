...
!function() {
    ...
    H[z].shims || (H[z].shims = []);
    var a = H[z], V = Object.assign || function(c) {
    ...
    !function(c) {
        ...
        !function c(h, v) {
            ...
            "function" == typeof a.hooks.addPack ? a.hooks.addPack(h, l) : a.styles[h] = V({}, a.styles[h] || {}, l), 
            "fas" === h && c("fa", v);
        }("fas", f);
    });
}();