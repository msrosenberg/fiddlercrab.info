...
!function() {
    ...
    var h = (c.navigator || {}).userAgent, z = void 0 === h ? "" : h, v = c, M = l, a = (v.document, 
    !!M.documentElement && !!M.head && "function" == typeof M.addEventListener && M.createElement, 
    ~z.indexOf("MSIE") || z.indexOf("Trident/"), "___FONT_AWESOME___"), m = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    var H = s[a];
    function V(c, z) {
        var l = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, h = void 0 !== l && l, v = Object.keys(z).reduce(function(c, l) {
            var h = z[l];
        ...
        "function" != typeof H.hooks.addPack || h ? H.styles[c] = function(v) {
            ...
            return v;
        }({}, H.styles[c] || {}, v) : H.hooks.addPack(c, v), "fas" === c && V("fa", z);
    }
    var L = {
