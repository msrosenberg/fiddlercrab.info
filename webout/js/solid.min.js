...
!function() {
    ...
    var h = (c.navigator || {}).userAgent, v = void 0 === h ? "" : h, z = c, M = l, s = (z.document, 
    ...
    var H = z || {};
    H[s] || (H[s] = {}), H[s].styles || (H[s].styles = {}), H[s].hooks || (H[s].hooks = {}), 
    H[s].shims || (H[s].shims = []);
    var V = H[s];
    function a(c, v) {
        var l = Object.keys(v).reduce(function(c, l) {
            var h = v[l];
            return !!h.icon ? c[h.iconName] = h.icon : c[l] = h, c;
        }, {});
        "function" == typeof V.hooks.addPack ? V.hooks.addPack(c, l) : V.styles[c] = function(z) {
            for (var c = 1; c < arguments.length; c++) {
                ...
                "function" == typeof Object.getOwnPropertySymbols && (l = l.concat(Object.getOwnPropertySymbols(M).filter(function(c) {
                    ...
                    var l, h, v;
                    l = z, v = M[h = c], h in l ? Object.defineProperty(l, h, {
                        value: v,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
