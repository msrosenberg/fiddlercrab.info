!function() {
    ...
    function v(t, n) {
        var e = "function" == typeof n ? n : Ct;
        0 === t.length ? e() : (V.requestAnimationFrame || function(t) {
            return t();
        })(function() {
            var n = p(), r = At.begin("mutate");
            t.map(n), r(), e();
        });
    }
    function b(t) {
    ...
    function N(t) {
        var n = Yt(t), e = n.iconName, r = n.prefix, i = n.rest, a = Tt(t), o = Vt(t), s = qt(t), f = Kt(t), l = Gt(t);
        return {
            iconName: e,
    ...
    function z(t, n) {
        ...
        } else if (t && n && !gt.showMissingIcons) throw new E("Icon is missing for prefix " + n + " with icon name " + t);
        return e;
    }
    function A(t, n) {
    ...
    function S(t) {
        var n = N(t);
        return ~n.extra.classes.indexOf(en) ? C(t, n) : A(t, n);
    }
    function L(t) {
        var n = At.begin("searchPseudoElements");
        b(function() {
            i(t.querySelectorAll("*")).forEach(function(t) {
                [ ":before", ":after" ].forEach(function(n) {
                    var e = V.getComputedStyle(t, n), r = e.getPropertyValue("font-family").match(rn), a = i(t.children).filter(function(t) {
                        return t.getAttribute(tt) === n;
                    })[0];
                    if (!r && a && a.remove(), r && !a) {
                        var o = e.getPropertyValue("content"), s = q.createElement("i");
                        s.setAttribute("class", "" + an[r[1]]), s.setAttribute(tt, n), s.innerText = 3 === o.length ? o.substr(1, 1) : o, 
    ...
    function T(t) {
        ...
        if (0 !== s.length) {
            ...
            if (f.length > 0) {
                ...
                var l = At.begin("onTree"), c = f.reduce(function(t, n) {
                    try {
                        var e = S(n);
                        e && t.push(e);
                    } catch (t) {
                        et || t instanceof E && console.error(t);
                    }
                    return t;
                }, []);
                l(), v(c, function() {
    ...
    function W(t) {
        ...
        if (r) return M(un.definitions, e, r) || M(Ot.styles, e, r);
    }
    ...
    var Ot = _t.___FONT_AWESOME___, Mt = function() {}, Nt = gt.measurePerformance && G && G.mark && G.measure ? G : {
        mark: Mt,
        measure: Mt
    }, Et = 'FA "5.0.0-rc5"', zt = function(t) {
        Nt.mark(Et + " " + t + " ends"), Nt.measure(Et + " " + t, Et + " " + t + " begins", Et + " " + t + " ends");
    }, At = {
        begin: function(t) {
            return Nt.mark(Et + " " + t + " begins"), function() {
                return zt(t);
            };
        },
        end: zt
        ...
        return o;
    }, It = Ot.styles, Ft = Ot.shims, Wt = {}, Bt = {}, Rt = {}, Xt = function() {
        var t = function(t) {
    ...
    }, nn = Ot.styles, en = "fa-layers-text", rn = /Font Awesome 5 (Solid|Regular|Light|Brands)/, an = {
        Solid: "fas",
        Regular: "far",
        Light: "fal",
        Brands: "fab"
    }, on = [], sn = (q.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(q.readyState);
    sn || q.addEventListener("DOMContentLoaded", function t() {
        q.removeEventListener("DOMContentLoaded", t), sn = 1, on.map(function(t) {
            return t();
        });
    });
    var fn = function(t) {
        q && (sn ? setTimeout(t, 0) : on.push(t));
    }, ln = function() {
    ...
    Object.defineProperty(mn, "config", {
        ...
        var t = function() {
            gt.autoReplaceSvg && mn.dom.i2svg({
                node: q
            });
        };
        J && (V.FontAwesome || (V.FontAwesome = mn), fn(function() {
            ...
            addPack: function(n, e) {
                Ot.styles[n] = ct({}, Ot.styles[n] || {}, e), Xt(), t();
            },
            addShims: function(n) {
                var e;
